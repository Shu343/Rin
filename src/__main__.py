...
def help_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            query.message.reply_edit(HELP_STRINGS,
                                     parse_mode=ParseMode.MARKDOWN,
                                     reply_markup=InlineKeyboardMarkup(
            ...
            query.message.reply_edit(text=HELP_STRINGS,
                                     parse_mode=ParseMode.MARKDOWN,
...
def main():
    ...
    start_callback_handler = CallbackQueryHandler(start_back, pattern=r"start_back")
