...
import html
import requests
import src.modules.sql.chatbot_sql as sql
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "AI Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update, context) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "AI Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
