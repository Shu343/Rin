...
MUTE_HANDLER = CommandHandler(
    ["stfu", "mute", "gay"], mute, pass_args=True, filters=Filters.group
)
UNMUTE_HANDLER = CommandHandler(
    ["unmute", "talk"], unmute, pass_args=True, filters=Filters.group
)
TEMPMUTE_HANDLER = CommandHandler(
    ["tmute", "tempmute", "tgay"], temp_mute, pass_args=True, filters=Filters.group
)
