        ...
        for new_mem in new_members:
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Ayy, one of my sudo users just joined! 👀"
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Ayy, one of my support users just joined! 👀"
                )
                continue
            ...
            # Make bot greet admins
                ...
                if welc_type != sql.Types.TEXT and welc_type != sql.Types.BUTTON_TEXT:
                    try:
                        ENUM_FUNC_MAP[welc_type](
                            chat.id, cust_welcome, reply_to_message_id=msg.message_id
                        )
                    except:
                ...
                sent = send(
                    update, res, keyboard, sql.DEFAULT_WELCOME.format(mention=mention)
                ...
                if welc_mutes == "strong":
                    ...
                    msg.reply_text(
                        "{}, click the button below to prove you're human.".format(
                            new_join_mem
                        ),
        ...
        if welcome_type == sql.Types.BUTTON_TEXT:
            ...
            if noformat:
                ...
                ENUM_FUNC_MAP[welcome_type](
                    chat.id, welcome_m, parse_mode=ParseMode.HTML
                )
