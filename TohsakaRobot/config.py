...
class Config(object):
    ...
    # REQUIRED
    API_KEY = '2039858522:AAHWCYTZ0C80vYOa9ASm4nOwbH2F94aNNJs'
    OWNER_ID = "1725431624"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "Its_shu3"

    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgres://xnxfhuip:O3Ycu2xTdY0KK_MANglIrcq0s9nB1K1R@lallah.db.elephantsql.com/xnxfhuip"  # needed for any database modules
